...
namespace PLMD{
	namespace colvar{
		class dsfThree : public Colvar {
			...
			public:
			explicit dsfThree(const ActionOptions&);
			~dsfThree();
			// active methods:
		...
		PLUMED_REGISTER_ACTION(dsfThree,"DSFTHREE")

			void dsfThree::registerKeywords( Keywords& keys ){
		...
		dsfThree::dsfThree(const ActionOptions&ao):
