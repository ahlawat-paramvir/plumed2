...
label: STRUCTURE_FACTOR_SPHERICALLY_AVERAGED NO_VIRIAL N2_MAX=30
...
public:
  StructureFactor_sphericallyAveraged(const ActionOptions&);
  virtual void calculate();
  static void registerKeywords(Keywords& );
};

PLUMED_REGISTER_ACTION(StructureFactor_sphericallyAveraged,"STRUCTURE_FACTOR_SPHERICALLY_AVERAGED")

void StructureFactor_sphericallyAveraged::registerKeywords(Keywords& keys)
{
...
StructureFactor_sphericallyAveraged::StructureFactor_sphericallyAveraged(const ActionOptions&ao):
...
// calculator
void StructureFactor_sphericallyAveraged::calculate()
{
...
void StructureFactor_sphericallyAveraged::init_fwv(std::vector<unsigned>& active_shells)
{
